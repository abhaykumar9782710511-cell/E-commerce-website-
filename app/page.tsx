...
export default function Home(){
 ...
 return <>
  ...
  <main>
   <section className="hero hero-new"><div className="hero-copy"><span className="hero-badge">🪷 अपनी संस्कृति, अपनी पहचान</span><h1>श्री कृष्ण जी की<br/><em>पोशाक, आपके लिए</em></h1><p>सुंदर, पारंपरिक और मनमोहक वस्त्र — अब आपके ठाकुर जी के लिए एक जगह पर।</p><Link className="btn hero-btn" href="/products">Shop Now&nbsp; →</Link><div className="hero-trust"><span>🚚 Pan India Delivery</span><span>🛡️ Secure Payments</span><span>♡ Trusted by Devotees</span></div></div><div className="hero-art"><div className="krishna-orb">🦚</div><div className="art-text">वस्त्र<br/><small>सेवा • भक्ति</small></div></div></section>
